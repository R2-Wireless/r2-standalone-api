...
export type DetectionResolvers<ContextType = GraphqlContext, ParentType extends ResolversParentTypes['Detection'] = ResolversParentTypes['Detection']> = ResolversObject<{
...
export type MutationResolvers<ContextType = GraphqlContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  start_detection?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationStart_DetectionArgs, 'save_record_data'>>;
...
export type SubscriptionResolvers<ContextType = GraphqlContext, ParentType extends ResolversParentTypes['Subscription'] = ResolversParentTypes['Subscription']> = ResolversObject<{
  detections?: SubscriptionResolver<Array<ResolversTypes['Detection']>, "detections", ParentType, ContextType>;
  status?: SubscriptionResolver<ResolversTypes['Status'], "status", ParentType, ContextType>;
  test?: SubscriptionResolver<ResolversTypes['Int'], "test", ParentType, ContextType>;
}>;
